...
class PublicUserApiTests(TestCase):
    ...
    def test_user_exists(self):
        """Test user that is already created"""
        payload = {
            'email': 'test@londonapp.com',
            'password': 'testpass',
            'name': "Test",
    ...
    def test_create_token_for_user(self):
        ...
        payload = {'email': 'test@londonapp.com', 'password': 'testpass'}
        create_user(**payload)
    ...
    def test_create_token_invalid_credentials(self):
        """Test that token is not created if invalid crendentials are given"""
    ...
    def test_retrieve_user_unauthorized(self):
        """That the authentication is required for users"""
